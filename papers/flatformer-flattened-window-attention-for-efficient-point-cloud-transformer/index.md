...
authors: Zhijian Liu*, Xinyu Yang*, Haotian Tang, Shang Yang, Fei Wang
...
coverAlt: Cover image for FlatFormer: Flattened Window Attention for Efficient Point Cloud Transformer
eyebrow: Publication
---
...
```bibtex
@inproceedings{flatformer-flattened-window-attention-for-efficient-point-cloud-transformer,
  title = {FlatFormer: Flattened Window Attention for Efficient Point Cloud Transformer},
  author = {Zhijian Liu and Xinyu Yang and Haotian Tang and Shang Yang and Fei Wang},
  booktitle = {CVPR 2023},
  year = {2023}
}
```
