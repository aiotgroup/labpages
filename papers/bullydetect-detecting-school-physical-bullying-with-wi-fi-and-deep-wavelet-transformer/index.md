...
```bibtex
@inproceedings{bullydetect-detecting-school-physical-bullying-with-wi-fi-and-deep-wavelet-transformer,
  title = {BullyDetect: Detecting School Physical Bullying with Wi-Fi and Deep Wavelet Transformer},
  author = {Bo Lan and Fei Wang# and Lekun Xia and Fan Nai and Shiqiang Nie and Han Ding and Jinsong Han},
  booktitle = {IEEE Internet of Things Journal, 2024},
  year = {2024}
}
```
