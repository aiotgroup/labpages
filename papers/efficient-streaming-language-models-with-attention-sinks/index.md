...
authors: Guangxuan Xiao, Yuandong Tian, Beidi Chen, Fei Wang, Mike Lewis
...
coverAlt: Cover image for Efficient Streaming Language Models with Attention Sinks
eyebrow: Publication
---
...
```bibtex
@inproceedings{efficient-streaming-language-models-with-attention-sinks,
  title = {Efficient Streaming Language Models with Attention Sinks},
  author = {Guangxuan Xiao and Yuandong Tian and Beidi Chen and Fei Wang and Mike Lewis},
  booktitle = {ICLR 2024},
  year = {2024}
}
```
