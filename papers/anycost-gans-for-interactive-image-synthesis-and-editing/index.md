...
authors: Ji Lin, Richard Zhang, Frieder Ganz, Fei Wang, Jun-Yan Zhu
...
coverAlt: Cover image for Anycost GANs for Interactive Image Synthesis and Editing
eyebrow: Publication
---
...
```bibtex
@inproceedings{anycost-gans-for-interactive-image-synthesis-and-editing,
  title = {Anycost GANs for Interactive Image Synthesis and Editing},
  author = {Ji Lin and Richard Zhang and Frieder Ganz and Fei Wang and Jun-Yan Zhu},
  booktitle = {CVPR 2021},
  year = {2021}
}
```
