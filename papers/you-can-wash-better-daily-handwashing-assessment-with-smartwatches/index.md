...
authors: F Wang, X Wu, X Wang, J Chi, J Shi, D Huang
...
coverAlt: Cover image for You can wash better: Daily handwashing assessment with smartwatches
eyebrow: Publication
---
...
- Published at arXiv preprint arXiv:2112.06657, 2021.
...
```bibtex
@inproceedings{you-can-wash-better-daily-handwashing-assessment-with-smartwatches,
  title = {You can wash better: Daily handwashing assessment with smartwatches},
  author = {F Wang and X Wu and X Wang and J Chi and J Shi and D Huang},
  booktitle = {arXiv preprint arXiv:2112.06657, 2021},
  year = {2021}
}
```
