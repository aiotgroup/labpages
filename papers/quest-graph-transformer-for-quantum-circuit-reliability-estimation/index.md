...
```bibtex
@inproceedings{quest-graph-transformer-for-quantum-circuit-reliability-estimation,
  title = {QuEst: Graph Transformer for Quantum Circuit Reliability Estimation},
  author = {Hanrui Wang and Pengyu Liu and Jinglei Cheng and Zhiding Liang and Jiaqi Gu and Zirui Li and Yongshan Ding and Weiwen Jiang and Yiyu Shi and Xuehai Qian and David Z Pan and Frederic T Chong and Fei Wang},
  booktitle = {ICCAD 2022},
  year = {2022}
}
```
