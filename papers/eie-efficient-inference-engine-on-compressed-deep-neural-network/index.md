...
coverAlt: Cover image for EIE: efficient inference engine on compressed deep neural network
eyebrow: Publication
---
...
```bibtex
@inproceedings{eie-efficient-inference-engine-on-compressed-deep-neural-network,
  title = {EIE: efficient inference engine on compressed deep neural network},
