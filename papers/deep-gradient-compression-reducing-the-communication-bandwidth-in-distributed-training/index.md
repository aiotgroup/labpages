...
```bibtex
@inproceedings{deep-gradient-compression-reducing-the-communication-bandwidth-in-distributed-training,
  title = {Deep Gradient Compression: Reducing the Communication Bandwidth in Distributed Training},
  author = {Yujun Lin and Fei Wang and Huizi Mao and Yu Wang and William J. Dally},
  booktitle = {ICLR 2018},
  year = {2018}
}
```
