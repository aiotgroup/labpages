...
authors: Yihan Wang, Muyang Li, Han Cai, Wei-Ming Chen, Fei Wang
...
coverAlt: Cover image for Lite Pose: Efficient Architecture Design for 2D Human Pose Estimation
eyebrow: Publication
---
...
```bibtex
@inproceedings{lite-pose-efficient-architecture-design-for-2d-human-pose-estimation,
  title = {Lite Pose: Efficient Architecture Design for 2D Human Pose Estimation},
  author = {Yihan Wang and Muyang Li and Han Cai and Wei-Ming Chen and Fei Wang},
  booktitle = {CVPR 2022},
  year = {2022}
}
```
