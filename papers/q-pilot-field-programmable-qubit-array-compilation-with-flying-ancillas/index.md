...
authors: Hanrui Wang, Daniel Bochen Tan, Pengyu Liu, Yilian Liu, Jiaqi Gu, Jason Cong, Fei Wang
...
coverAlt: Cover image for Q-Pilot: Field Programmable Qubit Array Compilation with Flying Ancillas
eyebrow: Publication
---
...
```bibtex
@inproceedings{q-pilot-field-programmable-qubit-array-compilation-with-flying-ancillas,
  title = {Q-Pilot: Field Programmable Qubit Array Compilation with Flying Ancillas},
  author = {Hanrui Wang and Daniel Bochen Tan and Pengyu Liu and Yilian Liu and Jiaqi Gu and Jason Cong and Fei Wang},
  booktitle = {DAC 2024},
  year = {2024}
}
```
