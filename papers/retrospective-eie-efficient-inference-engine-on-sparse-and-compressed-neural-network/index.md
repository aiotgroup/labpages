...
authors: Fei Wang, Xingyu Liu, Huizi Mao , Jing Pu , Ardavan Pedram , Mark A. Horowitz , William J. Dally
...
coverAlt: Cover image for Retrospective: EIE: Efficient Inference Engine on Sparse and Compressed Neural Network
eyebrow: Publication
---
...
```bibtex
@inproceedings{retrospective-eie-efficient-inference-engine-on-sparse-and-compressed-neural-network,
  title = {Retrospective: EIE: Efficient Inference Engine on Sparse and Compressed Neural Network},
  author = {Fei Wang and Xingyu Liu and Huizi Mao and Jing Pu and Ardavan Pedram and Mark A. Horowitz and William J. Dally},
  booktitle = {ISCA 2023},
  year = {2023}
}
```
