...
authors: Han Cai, Ligeng Zhu, Fei Wang
...
coverAlt: Cover image for ProxylessNAS: Direct Neural Architecture Search on Target Task and Hardware
eyebrow: Publication
---
...
```bibtex
@inproceedings{proxylessnas-direct-neural-architecture-search-on-target-task-and-hardware,
  title = {ProxylessNAS: Direct Neural Architecture Search on Target Task and Hardware},
  author = {Han Cai and Ligeng Zhu and Fei Wang},
  booktitle = {ICLR 2019},
  year = {2019}
}
```
