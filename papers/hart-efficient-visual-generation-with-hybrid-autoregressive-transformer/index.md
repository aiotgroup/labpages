...
authors: Haotian Tang*, Yecheng Wu*, Shang Yang, Enze Xie, Junsong Chen, Junyu Chen, Zhuoyang Zhang, Han Cai, Yao Lu, Fei Wang
...
coverAlt: Cover image for HART: Efficient Visual Generation with Hybrid Autoregressive Transformer
eyebrow: Publication
---
...
```bibtex
@inproceedings{hart-efficient-visual-generation-with-hybrid-autoregressive-transformer,
  title = {HART: Efficient Visual Generation with Hybrid Autoregressive Transformer},
  author = {Haotian Tang and Yecheng Wu and Shang Yang and Enze Xie and Junsong Chen and Junyu Chen and Zhuoyang Zhang and Han Cai and Yao Lu and Fei Wang},
  booktitle = {ICLR 2025},
  year = {2025}
}
```
