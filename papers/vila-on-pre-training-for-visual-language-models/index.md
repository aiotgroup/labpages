...
authors: Ji Lin*, Hongxu Yin*, Wei Ping, Yao Lu, Pavlo Molchanov, Andrew Tao, Huizi Mao, Jan Kautz, Mohammad Shoeybi, Fei Wang
...
coverAlt: Cover image for VILA: On Pre-training for Visual Language Models
eyebrow: Publication
---
...
```bibtex
@inproceedings{vila-on-pre-training-for-visual-language-models,
  title = {VILA: On Pre-training for Visual Language Models},
  author = {Ji Lin and Hongxu Yin and Wei Ping and Yao Lu and Pavlo Molchanov and Andrew Tao and Huizi Mao and Jan Kautz and Mohammad Shoeybi and Fei Wang},
  booktitle = {CVPR 2024},
  year = {2024}
}
```
