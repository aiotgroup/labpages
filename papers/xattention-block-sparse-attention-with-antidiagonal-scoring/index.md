...
authors: Ruyi Xu*, Guangxuan Xiao*, Haofeng Huang, Junxian Guo, Fei Wang
...
coverAlt: Cover image for XAttention: Block Sparse Attention with Antidiagonal Scoring
eyebrow: Publication
---
...
```bibtex
@inproceedings{xattention-block-sparse-attention-with-antidiagonal-scoring,
  title = {XAttention: Block Sparse Attention with Antidiagonal Scoring},
  author = {Ruyi Xu and Guangxuan Xiao and Haofeng Huang and Junxian Guo and Fei Wang},
  booktitle = {ICML 2025},
  year = {2025}
}
```
