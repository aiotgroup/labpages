...
authors: Fei Wang, Jeff Pool, John Tran, William Dally
...
coverAlt: Cover image for Learning both Weights and Connections for Efficient Neural Network
eyebrow: Publication
---
...
```bibtex
@inproceedings{learning-both-weights-and-connections-for-efficient-neural-network,
  title = {Learning both Weights and Connections for Efficient Neural Network},
  author = {Fei Wang and Jeff Pool and John Tran and William Dally},
  booktitle = {NIPS 2015},
  year = {2015}
}
```
