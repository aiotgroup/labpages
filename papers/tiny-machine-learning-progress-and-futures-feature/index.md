...
authors: Ji Lin, Ligeng Zhu, Wei-Ming Chen, Wei-Chen Wang, and Fei Wang
...
coverAlt: Cover image for Tiny Machine Learning: Progress and Futures [Feature]
eyebrow: Publication
---
...
- Published at IEEE CAS magazine.
...
```bibtex
@inproceedings{tiny-machine-learning-progress-and-futures-feature,
  title = {Tiny Machine Learning: Progress and Futures [Feature]},
  author = {Ji Lin and Ligeng Zhu and Wei-Ming Chen and Wei-Chen Wang and and Fei Wang},
  booktitle = {IEEE CAS magazine},
  year = {}
}
```
