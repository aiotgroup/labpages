...
authors: Shang Yang*, Junxian Guo*, Haotian Tang, Qinghao Hu, Guangxuan Xiao, Jiaming Tang, Yujun Lin, Zhijian Liu, Yao Lu, Fei Wang
...
coverAlt: Cover image for LServe: Efficient Long-sequence LLM Serving with Unified Sparse Attention
eyebrow: Publication
---
...
```bibtex
@inproceedings{lserve-efficient-long-sequence-llm-serving-with-unified-sparse-attention,
  title = {LServe: Efficient Long-sequence LLM Serving with Unified Sparse Attention},
  author = {Shang Yang and Junxian Guo and Haotian Tang and Qinghao Hu and Guangxuan Xiao and Jiaming Tang and Yujun Lin and Zhijian Liu and Yao Lu and Fei Wang},
