...
authors: Zhijian Liu*, Haotian Tang*, Alexander Amini, Xinyu Yang, Huizi Mao, Daniela L. Rus, Fei Wang
...
coverAlt: Cover image for BEVFusion: Multi-Task Multi-Sensor Fusion with Unified Bird's-Eye View Representation
eyebrow: Publication
---
...
```bibtex
@inproceedings{bevfusion-multi-task-multi-sensor-fusion-with-unified-bird-s-eye-view-representation,
  title = {BEVFusion: Multi-Task Multi-Sensor Fusion with Unified Bird's-Eye View Representation},
  author = {Zhijian Liu and Haotian Tang and Alexander Amini and Xinyu Yang and Huizi Mao and Daniela L. Rus and Fei Wang},
  booktitle = {ICRA 2023},
  year = {2023}
}
```
