...
```bibtex
@inproceedings{pockengine-sparse-and-efficient-fine-tuning-in-a-pocket,
  title = {PockEngine: Sparse and Efficient Fine-tuning in a Pocket},
  author = {Ligeng Zhu and Lanxiang Hu and Ji Lin and Wei-Chen Wang and Wei-Ming Chen and Chuang Gan and Fei Wang},
  booktitle = {MICRO 2023},
  year = {2023}
}
```
