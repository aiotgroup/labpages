...
authors: Ji Lin, Wei-Ming Chen, Yujun Lin, John Cohn, Chuang Gan, Fei Wang
...
coverAlt: Cover image for MCUNet: Tiny Deep Learning on IoT Devices
eyebrow: Publication
---
...
```bibtex
@inproceedings{mcunet-tiny-deep-learning-on-iot-devices,
  title = {MCUNet: Tiny Deep Learning on IoT Devices},
  author = {Ji Lin and Wei-Ming Chen and Yujun Lin and John Cohn and Chuang Gan and Fei Wang},
