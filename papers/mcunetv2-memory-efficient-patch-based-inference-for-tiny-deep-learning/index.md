...
authors: Ji Lin, Wei-Ming Chen, Han Cai, Chuang Gan, Fei Wang
...
coverAlt: Cover image for MCUNetV2: Memory-Efficient Patch-based Inference for Tiny Deep Learning
eyebrow: Publication
---
...
```bibtex
@inproceedings{mcunetv2-memory-efficient-patch-based-inference-for-tiny-deep-learning,
  title = {MCUNetV2: Memory-Efficient Patch-based Inference for Tiny Deep Learning},
  author = {Ji Lin and Wei-Ming Chen and Han Cai and Chuang Gan and Fei Wang},
