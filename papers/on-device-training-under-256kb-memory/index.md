...
authors: Ji Lin*, Ligeng Zhu*, Wei-Ming Chen, Wei-Chen Wang, Chuang Gan, Fei Wang
...
coverAlt: Cover image for On-Device Training Under 256KB Memory
eyebrow: Publication
---
...
```bibtex
@inproceedings{on-device-training-under-256kb-memory,
  title = {On-Device Training Under 256KB Memory},
  author = {Ji Lin and Ligeng Zhu and Wei-Ming Chen and Wei-Chen Wang and Chuang Gan and Fei Wang},
