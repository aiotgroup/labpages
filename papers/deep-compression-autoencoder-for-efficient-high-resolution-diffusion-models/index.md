...
authors: Junyu Chen*, Han Cai*, Junsong Chen, Enze Xie, Shang Yang, Haotian Tang, Muyang Li, Yao Lu, Fei Wang
...
coverAlt: Cover image for Deep Compression Autoencoder for Efficient High-Resolution Diffusion Models
eyebrow: Publication
---
...
```bibtex
@inproceedings{deep-compression-autoencoder-for-efficient-high-resolution-diffusion-models,
  title = {Deep Compression Autoencoder for Efficient High-Resolution Diffusion Models},
  author = {Junyu Chen and Han Cai and Junsong Chen and Enze Xie and Shang Yang and Haotian Tang and Muyang Li and Yao Lu and Fei Wang},
  booktitle = {ICLR 2025},
  year = {2025}
}
```
