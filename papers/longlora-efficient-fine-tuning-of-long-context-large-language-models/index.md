...
```bibtex
@inproceedings{longlora-efficient-fine-tuning-of-long-context-large-language-models,
  title = {LongLoRA: Efficient Fine-tuning of Long-Context Large Language Models},
  author = {Yukang Chen and Shengju Qian and Haotian Tang and Xin Lai and Zhijian Liu and Fei Wang and Jiaya Jia},
  booktitle = {ICLR 2024},
  year = {2024}
}
```
