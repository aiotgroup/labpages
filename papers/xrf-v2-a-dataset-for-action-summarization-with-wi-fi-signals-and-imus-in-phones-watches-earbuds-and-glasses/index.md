...
<figure class="markdown-figure">
  ...
  <figcaption>Figure 5. Action tuples can be converted into assistant-style summaries for daily routine, health, and smart-home questions.</figcaption>
</figure>
...
<figure class="markdown-figure">
  ...
  <figcaption>Figure 6. XRF V2 supports single-device and multi-device configurations for studying practical sensing trade-offs.</figcaption>
</figure>

<figure class="markdown-figure">
  <img src="./assets/xrfv2-real-apartment.png" alt="Real apartment zero-shot evaluation layout and photos for XRF V2">
  <figcaption>Figure 7. The paper also evaluates deployment in a real apartment without fine-tuning.</figcaption>
</figure>
