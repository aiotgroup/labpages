...
```bibtex
@inproceedings{tinytl-reduce-activations-not-trainable-parameters-for-efficient-on-device-learning,
  title = {TinyTL: Reduce Activations, Not Trainable Parameters for Efficient On-Device Learning},
  author = {Han Cai and Chuang Gan and Ligeng Zhu and Fei Wang},
