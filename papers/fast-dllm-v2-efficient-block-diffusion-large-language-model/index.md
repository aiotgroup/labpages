---
title: Fast-dLLM v2: Efficient Block-Diffusion Large Language Model
authors: Chengyue Wu, Hao Zhang, Shuchen Xue, Shizhe Diao, Yonggan Fu, Zhijian Liu, Pavlo Molchanov, Ping Luo, Fei Wang, Enze Xie
...
coverAlt: Cover image for Fast-dLLM v2: Efficient Block-Diffusion Large Language Model
eyebrow: Publication
---
...
```bibtex
@inproceedings{fast-dllm-v2-efficient-block-diffusion-large-language-model,
  title = {Fast-dLLM v2: Efficient Block-Diffusion Large Language Model},
  author = {Chengyue Wu and Hao Zhang and Shuchen Xue and Shizhe Diao and Yonggan Fu and Zhijian Liu and Pavlo Molchanov and Ping Luo and Fei Wang and Enze Xie},
  booktitle = {ICLR 2026},
  year = {2026}
}
```
