...
authors: Zhijian Liu*, Haotian Tang*, Yujun Lin, Fei Wang
...
coverAlt: Cover image for Point-Voxel CNN for Efficient 3D Deep Learning
eyebrow: Publication
---
...
```bibtex
@inproceedings{point-voxel-cnn-for-efficient-3d-deep-learning,
  title = {Point-Voxel CNN for Efficient 3D Deep Learning},
  author = {Zhijian Liu and Haotian Tang and Yujun Lin and Fei Wang},
