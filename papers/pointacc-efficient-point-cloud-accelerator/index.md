...
authors: Yujun Lin, Zhekai Zhang, Haotian Tang, Hanrui Wang, Fei Wang
...
coverAlt: Cover image for PointAcc: Efficient Point Cloud Accelerator
eyebrow: Publication
---
...
```bibtex
@inproceedings{pointacc-efficient-point-cloud-accelerator,
  title = {PointAcc: Efficient Point Cloud Accelerator},
  author = {Yujun Lin and Zhekai Zhang and Haotian Tang and Hanrui Wang and Fei Wang},
  booktitle = {MICRO 2021},
  year = {2021}
}
```
