...
authors: Hanrui Wang, Zhekai Zhang, Fei Wang
...
coverAlt: Cover image for SpAtten: Efficient Sparse Attention Architecture with Cascade Token and Head Pruning
eyebrow: Publication
---
...
```bibtex
@inproceedings{spatten-efficient-sparse-attention-architecture-with-cascade-token-and-head-pruning,
  title = {SpAtten: Efficient Sparse Attention Architecture with Cascade Token and Head Pruning},
  author = {Hanrui Wang and Zhekai Zhang and Fei Wang},
  booktitle = {HPCA 2021},
  year = {2021}
}
```
