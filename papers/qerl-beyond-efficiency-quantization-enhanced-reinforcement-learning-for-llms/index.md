...
```bibtex
@inproceedings{qerl-beyond-efficiency-quantization-enhanced-reinforcement-learning-for-llms,
  title = {QeRL: Beyond Efficiency -- Quantization-enhanced Reinforcement Learning for LLMs},
  author = {Wei Huang and Yi Ge and Shuai Yang and Yicheng Xiao and Huizi Mao and Yujun Lin and Hanrong Ye and Sifei Liu and Ka Chun Cheung and Hongxu Yin and Yao Lu and Xiaojuan Qi and Fei Wang and Yukang Chen},
  booktitle = {ICLR 2026},
  year = {2026}
}
```
