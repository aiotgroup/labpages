...
authors: Hanrui Wang, Zirui Li, Jiaqi Gu, Yongshan Ding, Yujun Lin, David Z. Pan, Frederic T. Chong, Fei Wang
...
coverAlt: Cover image for QOC: Quantum On-Chip Training with Parameter Shift and Gradient Pruning
eyebrow: Publication
---
...
```bibtex
@inproceedings{qoc-quantum-on-chip-training-with-parameter-shift-and-gradient-pruning,
  title = {QOC: Quantum On-Chip Training with Parameter Shift and Gradient Pruning},
  author = {Hanrui Wang and Zirui Li and Jiaqi Gu and Yongshan Ding and Yujun Lin and David Z. Pan and Frederic T. Chong and Fei Wang},
  booktitle = {DAC 2022},
  year = {2022}
}
```
