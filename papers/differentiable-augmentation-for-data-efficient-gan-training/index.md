...
authors: Shengyu Zhao, Zhijian Liu, Ji Lin, Jun-Yan Zhu, Fei Wang
...
coverAlt: Cover image for Differentiable Augmentation for Data-Efficient GAN Training
eyebrow: Publication
---
...
```bibtex
@inproceedings{differentiable-augmentation-for-data-efficient-gan-training,
  title = {Differentiable Augmentation for Data-Efficient GAN Training},
  author = {Shengyu Zhao and Zhijian Liu and Ji Lin and Jun-Yan Zhu and Fei Wang},
