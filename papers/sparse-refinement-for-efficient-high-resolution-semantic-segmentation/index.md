...
authors: Zhijian Liu*, Zhuoyang Zhang*, Samir Khaki, Shang Yang, Haotian Tang, Chenfeng Xu, Kurt Keutzer, Fei Wang
...
coverAlt: Cover image for Sparse Refinement for Efficient High-Resolution Semantic Segmentation
eyebrow: Publication
---
...
```bibtex
@inproceedings{sparse-refinement-for-efficient-high-resolution-semantic-segmentation,
  title = {Sparse Refinement for Efficient High-Resolution Semantic Segmentation},
  author = {Zhijian Liu and Zhuoyang Zhang and Samir Khaki and Shang Yang and Haotian Tang and Chenfeng Xu and Kurt Keutzer and Fei Wang},
  booktitle = {ECCV 2024},
  year = {2024}
}
```
