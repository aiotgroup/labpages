...
authors: Ji Lin, Chuang Gan, Fei Wang
...
coverAlt: Cover image for TSM: Temporal Shift Module for Efficient Video Understanding
eyebrow: Publication
---
...
```bibtex
@inproceedings{tsm-temporal-shift-module-for-efficient-video-understanding,
  title = {TSM: Temporal Shift Module for Efficient Video Understanding},
  author = {Ji Lin and Chuang Gan and Fei Wang},
  booktitle = {ICCV 2019},
  year = {2019}
}
```
