...
authors: Jiaming Tang*, Yilong Zhao*, Kan Zhu, Guangxuan Xiao, Baris Kasikci, Fei Wang
...
coverAlt: Cover image for Quest: Query-Aware Sparsity for Efficient Long-Context LLM Inference
eyebrow: Publication
---
...
```bibtex
@inproceedings{quest-query-aware-sparsity-for-efficient-long-context-llm-inference,
  title = {Quest: Query-Aware Sparsity for Efficient Long-Context LLM Inference},
  author = {Jiaming Tang and Yilong Zhao and Kan Zhu and Guangxuan Xiao and Baris Kasikci and Fei Wang},
  booktitle = {ICML 2024},
  year = {2024}
}
```
