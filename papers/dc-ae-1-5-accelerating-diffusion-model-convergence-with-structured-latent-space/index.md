...
authors: Junyu Chen, Dongyun Zou, Wenkun He, Junsong Chen, Enze Xie, Fei Wang, Han Cai
...
coverAlt: Cover image for DC-AE 1.5: Accelerating Diffusion Model Convergence with Structured Latent Space
eyebrow: Publication
---
...
```bibtex
@inproceedings{dc-ae-1-5-accelerating-diffusion-model-convergence-with-structured-latent-space,
  title = {DC-AE 1.5: Accelerating Diffusion Model Convergence with Structured Latent Space},
  author = {Junyu Chen and Dongyun Zou and Wenkun He and Junsong Chen and Enze Xie and Fei Wang and Han Cai},
  booktitle = {ICCV 2025},
  year = {2025}
}
```
