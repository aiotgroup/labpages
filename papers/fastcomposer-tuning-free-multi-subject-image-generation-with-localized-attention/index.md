...
authors: Guangxuan Xiao*, Tianwei Yin*, William T. Freeman, Frdo Durand, Fei Wang
...
coverAlt: Cover image for FastComposer: Tuning-Free Multi-Subject Image Generation with Localized Attention
eyebrow: Publication
---
...
- Published at International Journal of Computer Vision 2024.
...
```bibtex
@inproceedings{fastcomposer-tuning-free-multi-subject-image-generation-with-localized-attention,
  title = {FastComposer: Tuning-Free Multi-Subject Image Generation with Localized Attention},
  author = {Guangxuan Xiao and Tianwei Yin and William T. Freeman and Frdo Durand and Fei Wang},
  booktitle = {International Journal of Computer Vision 2024},
  year = {2024}
}
```
