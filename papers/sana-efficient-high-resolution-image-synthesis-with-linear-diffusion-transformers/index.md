...
```bibtex
@inproceedings{sana-efficient-high-resolution-image-synthesis-with-linear-diffusion-transformers,
  title = {SANA: Efficient High-Resolution Image Synthesis with Linear Diffusion Transformers},
  author = {Enze Xie and Junsong Chen and Junyu Chen and Han Cai and Haotian Tang and Yujun Lin and Zhekai Zhang and Muyang Li and Ligeng Zhu and Yao Lu and Fei Wang},
  booktitle = {ICLR 2025},
  year = {2025}
}
```
