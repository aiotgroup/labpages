...
authors: Haotian Tang*, Zhijian Liu*, Shengyu Zhao, Yujun Lin, Ji Lin, Hanrui Wang, Fei Wang
...
coverAlt: Cover image for Searching Efficient 3D Architectures with Sparse Point-Voxel Convolution
eyebrow: Publication
---
...
```bibtex
@inproceedings{searching-efficient-3d-architectures-with-sparse-point-voxel-convolution,
  title = {Searching Efficient 3D Architectures with Sparse Point-Voxel Convolution},
  author = {Haotian Tang and Zhijian Liu and Shengyu Zhao and Yujun Lin and Ji Lin and Hanrui Wang and Fei Wang},
  booktitle = {ECCV 2020},
  year = {2020}
}
```
