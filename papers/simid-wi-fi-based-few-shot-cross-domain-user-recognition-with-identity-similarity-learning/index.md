...
coverAlt: Cover image for SimID: Wi-Fi-Based Few-Shot Cross-Domain User Recognition with Identity Similarity Learning
eyebrow: Publication
---
...
- Published at MDPI Sensors 2025.
...
```bibtex
@inproceedings{simid-wi-fi-based-few-shot-cross-domain-user-recognition-with-identity-similarity-learning,
  title = {SimID: Wi-Fi-Based Few-Shot Cross-Domain User Recognition with Identity Similarity Learning},
  author = {Zhijian Wang and Lei Ouyang and Shi Chen and Han Ding and Ge Wang and Fei Wang#},
  booktitle = {MDPI Sensors 2025},
  year = {2025}
}
```
