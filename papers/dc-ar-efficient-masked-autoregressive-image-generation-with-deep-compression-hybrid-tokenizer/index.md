...
authors: Yecheng Wu, Junyu Chen, Zhuoyang Zhang, Enze Xie, Jincheng Yu, Junsong Chen, Jinyi Hu, Yao Lu, Fei Wang, Han Cai
...
coverAlt: Cover image for DC-AR: Efficient Masked Autoregressive Image Generation with Deep Compression Hybrid Tokenizer
eyebrow: Publication
---
...
```bibtex
@inproceedings{dc-ar-efficient-masked-autoregressive-image-generation-with-deep-compression-hybrid-tokenizer,
  title = {DC-AR: Efficient Masked Autoregressive Image Generation with Deep Compression Hybrid Tokenizer},
  author = {Yecheng Wu and Junyu Chen and Zhuoyang Zhang and Enze Xie and Jincheng Yu and Junsong Chen and Jinyi Hu and Yao Lu and Fei Wang and Han Cai},
  booktitle = {ICCV 2025},
  year = {2025}
}
```
