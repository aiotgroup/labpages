...
authors: Hanrui Wang, Yongshan Ding, Jiaqi Gu, Zirui Li, Yujun Lin, David Z. Pan, Frederic T. Chong, Fei Wang
...
coverAlt: Cover image for QuantumNAS: Noise-Adaptive Search for Robust Quantum Circuits
eyebrow: Publication
---
...
```bibtex
@inproceedings{quantumnas-noise-adaptive-search-for-robust-quantum-circuits,
  title = {QuantumNAS: Noise-Adaptive Search for Robust Quantum Circuits},
  author = {Hanrui Wang and Yongshan Ding and Jiaqi Gu and Zirui Li and Yujun Lin and David Z. Pan and Frederic T. Chong and Fei Wang},
  booktitle = {HPCA 2022},
  year = {2022}
}
```
