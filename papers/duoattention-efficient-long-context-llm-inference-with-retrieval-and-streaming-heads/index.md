...
authors: Guangxuan Xiao, Jiaming Tang, Jingwei Zuo, Junxian Guo , Shang Yang, Haotian Tang, Yao Fu, Fei Wang 
...
coverAlt: Cover image for DuoAttention: Efficient Long-Context LLM Inference with Retrieval and Streaming Heads
eyebrow: Publication
---
...
```bibtex
@inproceedings{duoattention-efficient-long-context-llm-inference-with-retrieval-and-streaming-heads,
  title = {DuoAttention: Efficient Long-Context LLM Inference with Retrieval and Streaming Heads},
  author = {Guangxuan Xiao and Jiaming Tang and Jingwei Zuo and Junxian Guo and Shang Yang and Haotian Tang and Yao Fu and Fei Wang},
  booktitle = {ICLR 2025},
  year = {2025}
}
```
