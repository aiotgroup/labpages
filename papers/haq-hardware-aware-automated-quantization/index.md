...
authors: Kuan Wang*, Zhijian Liu*, Yujun Lin*, Ji Lin, and Fei Wang
...
coverAlt: Cover image for HAQ: Hardware-Aware Automated Quantization
eyebrow: Publication
---
...
```bibtex
@inproceedings{haq-hardware-aware-automated-quantization,
  title = {HAQ: Hardware-Aware Automated Quantization},
  author = {Kuan Wang and Zhijian Liu and Yujun Lin and Ji Lin and and Fei Wang},
  booktitle = {CVPR 2019},
  year = {2019}
}
```
