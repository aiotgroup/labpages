...
```bibtex
@inproceedings{condition-aware-neural-network-for-controlled-image-generation,
  title = {Condition-Aware Neural Network for Controlled Image Generation},
  author = {Han Cai and Muyang Li and Zhuoyang Zhang and Qinsheng Zhang and Ming-Yu Liu and Fei Wang},
  booktitle = {CVPR 2024},
  year = {2024}
}
```
