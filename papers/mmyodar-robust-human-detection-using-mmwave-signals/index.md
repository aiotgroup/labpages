...
coverAlt: Cover image for mmYodar+: Robust Human Detection using mmWave Signals
eyebrow: Publication
---
...
- Published at IEEE Internet of Things Journal, 2025.
...
```bibtex
@inproceedings{mmyodar-robust-human-detection-using-mmwave-signals,
  title = {mmYodar+: Robust Human Detection using mmWave Signals},
  author = {Yuance Chang and Han Ding# and Feng Cao and Cui Zhao and Fei Wang and Ge Wang and Zhi Wang and Wei Xi},
  booktitle = {IEEE Internet of Things Journal, 2025},
  year = {2025}
}
```
