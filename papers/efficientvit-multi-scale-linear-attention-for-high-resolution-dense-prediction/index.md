...
authors: Han Cai, Junyan Li, Muyan Hu, Chuang Gan, Fei Wang
...
coverAlt: Cover image for EfficientViT: Multi-Scale Linear Attention for High-Resolution Dense Prediction
eyebrow: Publication
---
...
```bibtex
@inproceedings{efficientvit-multi-scale-linear-attention-for-high-resolution-dense-prediction,
  title = {EfficientViT: Multi-Scale Linear Attention for High-Resolution Dense Prediction},
  author = {Han Cai and Junyan Li and Muyan Hu and Chuang Gan and Fei Wang},
  booktitle = {ICCV 2023},
  year = {2023}
}
```
