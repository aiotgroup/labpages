---
title: Security in Uplink MU-MIMO Networks
authors: F Wang, W Xi, J Han, K Zhao, Y Gao
...
coverAlt: Cover image for Security in Uplink MU-MIMO Networks
eyebrow: Publication
---
...
- Published at International Conference on Internet-of-Things Design and Implementation ..., 2017.
...
```bibtex
@inproceedings{security-in-uplink-mu-mimo-networks,
  title = {Security in Uplink MU-MIMO Networks},
  author = {F Wang and W Xi and J Han and K Zhao and Y Gao},
  booktitle = {International Conference on Internet-of-Things Design and Implementation ..., 2017},
  year = {2017}
}
```
