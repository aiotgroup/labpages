...
authors: Zhijian Liu*, Haotian Tang*, Sibo Zhu*, Fei Wang
...
coverAlt: Cover image for SemAlign: Annotation-Free Camera-LiDAR Calibration with Semantic Alignment Loss
eyebrow: Publication
---
...
```bibtex
@inproceedings{semalign-annotation-free-camera-lidar-calibration-with-semantic-alignment-loss,
  title = {SemAlign: Annotation-Free Camera-LiDAR Calibration with Semantic Alignment Loss},
  author = {Zhijian Liu and Haotian Tang and Sibo Zhu and Fei Wang},
  booktitle = {IROS 2021},
  year = {2021}
}
```
