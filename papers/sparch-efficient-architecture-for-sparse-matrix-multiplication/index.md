...
authors: Zhekai Zhang*, Hanrui Wang*, Fei Wang, William J. Dally
...
coverAlt: Cover image for SpArch: Efficient Architecture for Sparse Matrix Multiplication
eyebrow: Publication
---
...
```bibtex
@inproceedings{sparch-efficient-architecture-for-sparse-matrix-multiplication,
  title = {SpArch: Efficient Architecture for Sparse Matrix Multiplication},
  author = {Zhekai Zhang and Hanrui Wang and Fei Wang and William J. Dally},
  booktitle = {HPCA 2020},
  year = {2020}
}
```
