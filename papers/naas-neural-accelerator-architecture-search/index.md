...
authors: Yujun Lin *, Mengtian Yang *, Fei Wang
...
coverAlt: Cover image for NAAS: Neural Accelerator Architecture Search
eyebrow: Publication
---
...
```bibtex
@inproceedings{naas-neural-accelerator-architecture-search,
  title = {NAAS: Neural Accelerator Architecture Search},
  author = {Yujun Lin and Mengtian Yang and Fei Wang},
  booktitle = {DAC 2021},
  year = {2021}
}
```
