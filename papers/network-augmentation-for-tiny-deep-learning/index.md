...
authors: Han Cai, Chuang Gan, Ji Lin, Fei Wang
...
coverAlt: Cover image for Network Augmentation for Tiny Deep Learning
eyebrow: Publication
---
...
```bibtex
@inproceedings{network-augmentation-for-tiny-deep-learning,
  title = {Network Augmentation for Tiny Deep Learning},
  author = {Han Cai and Chuang Gan and Ji Lin and Fei Wang},
  booktitle = {ICLR 2022},
  year = {2022}
}
```
