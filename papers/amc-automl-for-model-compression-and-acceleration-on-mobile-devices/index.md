...
authors: Yihui He*, Ji Lin*, Zhijian Liu, Hanrui Wang, Li-Jia Li, and Fei Wang
...
coverAlt: Cover image for AMC: AutoML for Model Compression and Acceleration on Mobile Devices
eyebrow: Publication
---
...
```bibtex
@inproceedings{amc-automl-for-model-compression-and-acceleration-on-mobile-devices,
  title = {AMC: AutoML for Model Compression and Acceleration on Mobile Devices},
  author = {Yihui He and Ji Lin and Zhijian Liu and Hanrui Wang and Li-Jia Li and and Fei Wang},
  booktitle = {ECCV 2018},
  year = {2018}
}
```
