...
authors: Zhanghao Wu*, Zhijian Liu*, Ji Lin, Yujun Lin, Fei Wang
...
coverAlt: Cover image for Lite Transformer with Long-Short Range Attention
eyebrow: Publication
---
...
```bibtex
@inproceedings{lite-transformer-with-long-short-range-attention,
  title = {Lite Transformer with Long-Short Range Attention},
  author = {Zhanghao Wu and Zhijian Liu and Ji Lin and Yujun Lin and Fei Wang},
  booktitle = {ICLR 2020},
  year = {2020}
}
```
