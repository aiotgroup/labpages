...
coverAlt: Cover image for Federated Multi-Source Domain Adaptation for mmWave-based Human Activity Recognition
eyebrow: Publication
---
...
```bibtex
@inproceedings{federated-multi-source-domain-adaptation-for-mmwave-based-human-activity-recognition,
  title = {Federated Multi-Source Domain Adaptation for mmWave-based Human Activity Recognition},
