...
authors: Fei Wang, Huizi Mao, and William J. Dally
...
coverAlt: Cover image for Deep Compression: Compressing Deep Neural Networks with Pruning, Trained Quantization and Huffman Coding
eyebrow: Publication
---
...
```bibtex
@inproceedings{deep-compression-compressing-deep-neural-networks-with-pruning-trained-quantization-and-huffman-coding,
  title = {Deep Compression: Compressing Deep Neural Networks with Pruning, Trained Quantization and Huffman Coding},
  author = {Fei Wang and Huizi Mao and and William J. Dally},
  booktitle = {ICLR 2016},
  year = {2016}
}
```
