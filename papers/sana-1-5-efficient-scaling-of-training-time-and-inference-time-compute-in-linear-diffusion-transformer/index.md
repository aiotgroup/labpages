...
```bibtex
@inproceedings{sana-1-5-efficient-scaling-of-training-time-and-inference-time-compute-in-linear-diffusion-transformer,
  title = {SANA-1.5: Efficient Scaling of Training-Time and Inference-Time Compute in Linear Diffusion Transformer},
  author = {Enze Xie and Junsong Chen and Yuyang Zhao and Jincheng Yu and Ligeng Zhu and Chengyue Wu and Yujun Lin and Zhekai Zhang and Muyang Li and Junyu Chen and Han Cai and Bingchen Liu and Daquan Zhou and Fei Wang},
  booktitle = {ICML 2025},
  year = {2025}
}
```
