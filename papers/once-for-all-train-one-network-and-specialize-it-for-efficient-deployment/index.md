...
```bibtex
@inproceedings{once-for-all-train-one-network-and-specialize-it-for-efficient-deployment,
  title = {Once-for-All: Train One Network and Specialize it for Efficient Deployment},
  author = {Han Cai and Chuang Gan and Tianzhe Wang and Zhekai Zhang and Fei Wang},
  booktitle = {ICLR 2020},
  year = {2020}
}
```
