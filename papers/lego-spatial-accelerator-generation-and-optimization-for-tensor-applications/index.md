...
authors: Yujun Lin*, Zhekai Zhang*, Fei Wang
...
coverAlt: Cover image for LEGO: Spatial Accelerator Generation and Optimization for Tensor Applications
eyebrow: Publication
---
...
```bibtex
@inproceedings{lego-spatial-accelerator-generation-and-optimization-for-tensor-applications,
  title = {LEGO: Spatial Accelerator Generation and Optimization for Tensor Applications},
  author = {Yujun Lin and Zhekai Zhang and Fei Wang},
  booktitle = {HPCA 2025},
  year = {2025}
}
```
