...
1. Image Classification, **VGG:** Karen Simonyan and Andrew Zisserman [Very deep convolutional networks for large-scale image recognition](https://arxiv.org/abs/1409.1556) / [pytorch](https://github.com/pytorch/vision/blob/main/torchvision/models/vgg.py)
...
4. Semantic Segmentation, **U-Net:** Olaf Ronneberger *et al.*, [U-Net: Convolutional Networks for Biomedical Image Segmentation](https://arxiv.org/abs/1505.04597) / [pytorch](https://amaarora.github.io/2020/09/13/unet.html)
